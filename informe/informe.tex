...
\hline
C1 etiquetado        & 1.65 & 43 & 42.3 & 65.4 & 275.8 \\
C2 +excentricidad    & 1.69 & 44 & 42.3 & 61.5 & 122.8 \\
\textbf{C3 k-means}  & \textbf{1.50} & \textbf{39} & \textbf{50.0} & \textbf{69.2} & 226.2 \\
\hline
\end{tabular}
\end{table}
...
\hline
Componentes + bbox (C2) & 1.69 & 42.3 & 122.8 & media & media (área, ecc., disk) & bajo \\
k-means (C3)            & 1.50 & 50.0 & 226.2 & media-alta & alta ($k$, semilla) & alto \\
\hline
\end{tabular}
\end{table}
